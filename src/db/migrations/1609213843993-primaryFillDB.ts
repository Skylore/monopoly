...
export class primaryFillDB1609213843993 implements MigrationInterface {
    name = 'primaryFillDB1609213843993'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `Player` (`id` int NOT NULL AUTO_INCREMENT, `nick` varchar(255) NOT NULL, `position` int NOT NULL DEFAULT '0', `userId` int NOT NULL, `sessionId` int NOT NULL, `isParked` tinyint NOT NULL DEFAULT 0, `isPrisoned` tinyint NOT NULL DEFAULT 0, `createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `Group` (`id` int NOT NULL AUTO_INCREMENT, `type` enum ('start', 'prison', 'parking', 'toPrison', 'game', 'diceRoll', 'collection', 'chance') NOT NULL DEFAULT 'game', `color` varchar(255) NOT NULL, `createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `Chaining` (`id` int NOT NULL AUTO_INCREMENT, `cardId` int NOT NULL, `groupId` int NOT NULL, `createdAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
